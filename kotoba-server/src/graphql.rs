		...
		r#"
			...
			<html>
				<head>
					...
					<script src="//cdn.jsdelivr.net/npm/react@17.0.2/umd/react.production.min.js"></script>
					<script src="//cdn.jsdelivr.net/npm/react-dom@17.0.2/umd/react-dom.production.min.js"></script>
					<link rel="stylesheet" href="//cdn.jsdelivr.net/npm/graphiql@1.4.2/graphiql.min.css" />
