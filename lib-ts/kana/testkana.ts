...
export const BASIC_KANA: Kana[] = [
	...
	// Non-converted ASCII characters should be converted to full-width. This
	// means digits and plain consonants.
	x('０', '０', '0', { from_kana: false }),
	x('１', '１', '1', { from_kana: false }),
	x('２', '２', '2', { from_kana: false }),
	x('３', '３', '3', { from_kana: false }),
	x('４', '４', '4', { from_kana: false }),
	x('５', '５', '5', { from_kana: false }),
	x('６', '６', '6', { from_kana: false }),
	x('７', '７', '7', { from_kana: false }),
	x('８', '８', '8', { from_kana: false }),
	x('９', '９', '9', { from_kana: false }),
	x('Ａ', 'Ａ', 'A', { from_kana: true }),
	x('Ｂ', 'Ｂ', 'B', { from_kana: false }),
	x('Ｃ', 'Ｃ', 'C', { from_kana: false }),
	x('Ｄ', 'Ｄ', 'D', { from_kana: false }),
	x('Ｅ', 'Ｅ', 'E', { from_kana: true }),
	x('Ｆ', 'Ｆ', 'F', { from_kana: false }),
	x('Ｇ', 'Ｇ', 'G', { from_kana: false }),
	x('Ｈ', 'Ｈ', 'H', { from_kana: false }),
	x('Ｉ', 'Ｉ', 'I', { from_kana: true }),
	x('Ｊ', 'Ｊ', 'J', { from_kana: false }),
	x('Ｋ', 'Ｋ', 'K', { from_kana: false }),
	x('Ｌ', 'Ｌ', 'L', { from_kana: false }),
	x('Ｍ', 'Ｍ', 'M', { from_kana: false }),
	x('Ｎ', 'Ｎ', 'N', { from_kana: true }), // N is converted to ん
	x('Ｏ', 'Ｏ', 'O', { from_kana: true }),
	x('Ｐ', 'Ｐ', 'P', { from_kana: false }),
	x('Ｑ', 'Ｑ', 'Q', { from_kana: false }),
	x('Ｒ', 'Ｒ', 'R', { from_kana: false }),
	x('Ｓ', 'Ｓ', 'S', { from_kana: false }),
	x('Ｔ', 'Ｔ', 'T', { from_kana: false }),
	x('Ｕ', 'Ｕ', 'U', { from_kana: true }),
	x('Ｖ', 'Ｖ', 'V', { from_kana: false }),
	x('Ｗ', 'Ｗ', 'W', { from_kana: false }),
	x('Ｘ', 'Ｘ', 'X', { from_kana: false }),
	x('Ｙ', 'Ｙ', 'Y', { from_kana: false }),
	x('Ｚ', 'Ｚ', 'Z', { from_kana: false }),
	x('ａ', 'ａ', 'a', { from_kana: true }),
	x('ｂ', 'ｂ', 'b', { from_kana: false }),
	x('ｃ', 'ｃ', 'c', { from_kana: false }),
	x('ｄ', 'ｄ', 'd', { from_kana: false }),
